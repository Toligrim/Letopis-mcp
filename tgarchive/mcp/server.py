...
Use total_hits and aggregate_messages to check corpus coverage. When aggregation reveals an important small cluster, inspect relevant periods or topics. Do not compare raw BM25 scores from different queries. search_messages is for discovery, and a snippet is not a full message.
...
def search_messages(
    ...
    """Search messages and return structured evidence hits."""
