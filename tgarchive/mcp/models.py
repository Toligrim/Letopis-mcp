...
METADATA_STRING_MAX_CHARS: Final[int] = 400
...
SEARCH_FILTER_ID_LIST_MAX: Final[int] = 20
SEARCH_FILTER_SENDER_NAME_MAX_CHARS: Final[int] = 120
SEARCH_FILTER_DATE_MAX_CHARS: Final[int] = 10
SEARCH_FILTER_DATE_PATTERN: Final[str] = r"^\d{4}(?:-\d{2}){0,2}$"
CURSOR_MAX_CHARS: Final[int] = 2_048
...
FETCH_PER_MESSAGE_MAX_CHARS_MIN: Final[int] = 1_000
...
CONTEXT_MESSAGE_MAX_CHARS_MIN: Final[int] = 500
